...
import com.intuit.court.booking.system.csvupload.CourtCSV;
import com.intuit.court.booking.system.csvupload.SportCSV;
...
import static com.intuit.court.booking.system.helpers.DateUtil.convertToTimestamp;
...
public class CSVService {
    ...
    private boolean validateTimings(CourtCSV courtCSV) {
        ...
        if (!openingTimestamp.toLocalDateTime().isBefore(closingTimestamp.toLocalDateTime())) {
            ...
            throw new SportManagementCSVException("Invalding courtTimings", FailureCodes.INVALID_TIMING);
        }
